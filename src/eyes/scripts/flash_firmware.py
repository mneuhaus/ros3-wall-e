#!/usr/bin/env python3
"""
Flash firmware to Eyes display board using picotool.
"""
...
def flash_firmware(firmware_path):
    ...
    if not os.path.exists(firmware_path):
        ...
        print("cd src/eyes/firmware && mkdir build && cd build && cmake .. && make")
        return False
...
def main():
    ...
    firmware_path = os.path.join(script_dir, '../firmware/build/eyes.uf2')
